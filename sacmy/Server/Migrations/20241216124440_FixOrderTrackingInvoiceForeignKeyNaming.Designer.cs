...
namespace sacmy.Server.Migrations
{
    ...
    [Migration("20241216124440_FixOrderTrackingInvoiceForeignKeyNaming")]
    partial class FixOrderTrackingInvoiceForeignKeyNaming
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sacmy.Server.Models.OrderTrackingInvoice", b =>
                {
                    b.HasOne("sacmy.Server.Models.BuyFatora", null)
                    ...
                    b.HasOne("sacmy.Server.Models.BuyFatora", "Invoice")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_OrderTrackingInvoice_BuyFatora");
                    ...
                    b.HasOne("sacmy.Server.Models.OrderTracking", "OrderTracking")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_OrderTrackingInvoice_OrderTracking");
